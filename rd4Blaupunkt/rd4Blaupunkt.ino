...
void ShowKey()
{
  char klawisz[20];
   if (wiersz!=B11111) 
   {
     if ((kolumna==B11101)&(wiersz==B11110)) GoPress((char *)"AUDIO"  ,4,5);
     if ((kolumna==B11101)&(wiersz==B11011)) GoPress((char *)"SOURCE" ,1,2);
     if ((kolumna==B11110)&(wiersz==B11011)) GoPress((char *)"TRIP"   ,4,5);
     if ((kolumna==B11101)&(wiersz==B11101)) GoPress((char *)"BAND"   ,5,2);
     if ((kolumna==B11110)&(wiersz==B11101)) GoPress((char *)"CLIM"   ,4,5);
     if ((kolumna==B11101)&(wiersz==B10111)) GoPress((char *)"DARK"   ,2,5);
     if ((kolumna==B11011)&(wiersz==B11110)) GoPress((char *)"ESC"    ,2,1);
     if ((kolumna==B11110)&(wiersz==B10111)) GoPress((char *)"MENU"   ,4,3);
     if ((kolumna==B11101)&(wiersz==B01111)) GoPress((char *)"TONE"   ,3,4);
     if ((kolumna==B11011)&(wiersz==B11101)) GoPress((char *)"UP"     ,5,3);
     if ((kolumna==B11011)&(wiersz==B10111)) GoPress((char *)"DOWN"   ,1,1);
     if ((kolumna==B11011)&(wiersz==B11011)) GoPress((char *)"LEFT"   ,5,1);
     if ((kolumna==B10111)&(wiersz==B11011)) GoPress((char *)"RIGHT"  ,2,3);
     if ((kolumna==B11011)&(wiersz==B01111)) GoPress((char *)"OK"     ,3,3);
     if ((kolumna==B10111)&(wiersz==B11110)) GoPress((char *)"TA"     ,1,3);
     if ((kolumna==B10111)&(wiersz==B11101)) GoPress((char *)"LIST"   ,3,1);
     if ((kolumna==B10111)&(wiersz==B10111)) GoPress((char *)"PTY"    ,1,3);
     if ((kolumna==B10111)&(wiersz==B01111)) GoPress((char *)"1"      ,3,5);
     if ((kolumna==B01111)&(wiersz==B11101)) GoPress((char *)"2"      ,3,2);
     if ((kolumna==B01111)&(wiersz==B10111)) GoPress((char *)"3"      ,2,2);
     if ((kolumna==B01111)&(wiersz==B11110)) GoPress((char *)"4"      ,2,4);
     if ((kolumna==B01111)&(wiersz==B11011)) GoPress((char *)"5"      ,5,4);
     if ((kolumna==B01111)&(wiersz==B01111)) GoPress((char *)"6"      ,1,4);
     if ((kolumna==B11110)&(wiersz==B11110)) GoPress((char *)"EJECT"  ,4,2);
    /* 
